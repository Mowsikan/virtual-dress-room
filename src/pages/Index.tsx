          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-12">
                Have questions about our virtual try-on technology? We'd love to hear from you and help revolutionize your shopping experience.
              </p>
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Subscribe to our newsletter for the latest updates on virtual try-on technology and fashion innovation.
            </p>
            <form className="flex flex-col md:flex-row gap-4 justify-center">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-6 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/20 flex-1 max-w-md"
              />
              <button
                type="submit"
...
const contactInfo = [
  {
    title: "Email Us",
    content: "support@virtualfit.com",
    icon: (
  ...
  {
    title: "Visit Us",
    content: "123 Fashion Street, Style City, ST 12345",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
